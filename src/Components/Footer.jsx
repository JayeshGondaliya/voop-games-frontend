        ...
        <footer className="text-white p-4 ">
            <div className="fluid-container mx-auto max-w-7xl">
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:space-x-8 items-center md:items-start text-center sm:text-wrap">
                    ...
                    {/* Description */}
                    <div className="md:flex-1 max-w-md mx-auto md:mx-0 flex flex-col items-start mb-8 md:mb-0">
                    ...
                    {/* Links + Social */}
                    <div className=" flex flex-nowrap md:flex-wrap lg:flex-nowrap lg:justify-around gap-4 md:gap-8 md:justify-between text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl md:flex-1 max-w-3xl mx-auto">

                        {/* Our Links */}
                        <div className="text-left w-1/2 md:w-auto">
                            <h3 className="text-sm sm:text-base md:text-xl font-semibold mb-4">Our Links</h3>
                            <ul className="space-y-2">
                                <li className="hover:text-indigo-400 cursor-pointer sm:text-base">Developers</li>
                                <li className="hover:text-indigo-400 cursor-pointer sm:text-base">Affiliate</li>
                                <li className="hover:text-indigo-400 cursor-pointer sm:text-base">Contact Us</li>
                                <li className="hover:text-indigo-400 cursor-pointer sm:text-base">About</li>
                            </ul>
                        </div>
                        ...
                        <div className="text-left w-1/2 md:w-auto">
                            ...
                            <div className="flex justify-center md:justify-start space-x-3 mb-4">
                                ...
                                <div className="w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-blue-400 hover:bg-indigo-700 transition flex items-center justify-center" title="Twitter">
                                    <i className="fab fa-twitter text-white text-xs sm:text-sm md:text-base"></i>
                                </div>
                                <div className="w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-pink-500 hover:bg-indigo-700 transition flex items-center justify-center" title="Instagram">
                                    <i className="fab fa-instagram text-white text-xs sm:text-sm md:text-base"></i>
                                </div>
                                <div className="w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-red-600 hover:bg-indigo-700 transition flex items-center justify-center" title="Pinterest">
                                    <i className="fab fa-pinterest-p text-white text-xs sm:text-sm md:text-base"></i>
                                </div>
                            </div>

                            {/* Terms */}
                            <div className="flex flex-col space-y-2 font-bold text-center text-base">
                                <p className="hover:text-indigo-400 cursor-pointer">Terms of Use</p>
                                <p className="hover:text-indigo-400 cursor-pointer">Privacy Policy</p>
                            </div>
                        </div>
                    </div>
            ...
            {/* Developed By */}
            <div className="text-center text-white py-2 mt-8 text-sm">
                <p>
